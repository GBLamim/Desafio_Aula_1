...
def index():
    ...
    print(name)
    variaveis = {"motive":"Desafio da Primeira Aula","table":"Produtos","array":[{"name":"Garrafa","value":"12.99"},{"name":"Calculadora","value":"4.98"},{"name":"Impressora","value":"875.65"},{"name":"Mouse","value":"75.95"},{"name":"Vaso","value":"80.0"}]}
